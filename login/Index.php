...
<form action="POST" class="form_login">
  <div class="form sign-in">
    ...
    <div id="msg_error1" class="alert-danger" role="alert" style="display: none"></div>
    <label>
      <span>Contraseña</span>
      <input type="password" id="contrasena" name="contra" require />
    </label>   
    <div id="msg_error2" class="alert-danger" role="alert" style="display: none"></div> 
    ...
    <div id="msg_error" class="alert-danger" role="alert" style="display: none"></div>
    <div id="msg_errors" class="alert-danger" role="alert" style="display: none"></div>
  </form>
  </div>
  ...
  <div class="sub-cont">
    ...
    <div class="form sign-up">
     ...
     <option value="Alumno">Estudiante</option>
      ...
      <div id="msg_error2" class="alert alert-danger" role="alert" style="display: none"></div>!-->
    </div>
  </div>
</div>
